...
export const defaultProjects = [
  {
    ...
    description: "Sube tu CV en PDF y recibe feedback detallado impulsado por IA con sugerencias de mejora específicas para mejorar tu perfil profesional.",
    stack: ["React", "Node.js", "Anthropic API", "pdf-parse"],
    color: "#EC4899",
    icon: "🤖",
    liveUrl: "https://ai-resume-reviewer-seven.vercel.app",
    repoUrl: "https://github.com/Kevin30042001/ai-resume-reviewer",
    comingSoon: false,
    order: 1,
  },
  {
    ...
    description: "Directorio de empleos remotos con filtros avanzados, búsqueda en tiempo real y guardado de favoritos para desarrolladores.",
    stack: ["Next.js 14", "TypeScript", "Tailwind CSS", "Zustand"],
    color: "#F59E0B",
    icon: "💼",
    liveUrl: "https://job-board-drab-chi.vercel.app",
    repoUrl: "https://github.com/Kevin30042001/job-board",
    comingSoon: false,
    order: 2,
  },
  {
    id: "devlinks",
    name: "DevLinks",
    subtitle: "Agregador de Links para Devs",
    ...
    color: "#8B5CF6",
    icon: "🔗",
    liveUrl: "https://devlinks-one-tan.vercel.app",
    repoUrl: "https://github.com/Kevin30042001/devlinks",
    comingSoon: false,
    order: 3,
  },
  {
    ...
    repoUrl: "https://github.com/Kevin30042001/finance-tracker",
    comingSoon: false,
    order: 4,
  },
];
